...
const Navbar = () => {
  ...
  return <div className="navbar py-7 flex items-center justify-between">
    <div className="logo">
        ...
        <ul className={`menu flex items-center sm:gap-10 gap-4 md-static fixed right-1/20 -translate-x-1/5 md:-translate-x-0
        md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl rounded-bl-2xl md:bg-transparent transition-all
        md:transition-none z-40
        ${active ? "top-0 opacity-100" : "top-5 opacity-0"}`}>
            <li>
